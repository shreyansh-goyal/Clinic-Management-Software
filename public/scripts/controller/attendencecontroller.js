app.controller("attendencecontroller",function($scope){
    ...
    {
            fetch("https://ec2-13-232-8-74.ap-south-1.compute.amazonaws.com:1234/uploadattendence",{
            method: "POST", 
            mode: "cors",
            cache: "no-cache", 
    ...
    {
        $scope.attendence=[];
        fetch("https://ec2-13-232-8-74.ap-south-1.compute.amazonaws.com:1234/fetchemployee").then(data=>{
            data.json().then(data=>{
    ...
    $scope.addemployee=()=>
    {
        ...
        fetch("https://ec2-13-232-8-74.ap-south-1.compute.amazonaws.com:1234/addemployee",{
                method: "POST", 
                mode: "cors",
                cache: "no-cache", 
                credentials: "same-origin", 
